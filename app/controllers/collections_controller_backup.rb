class CollectionsControllerBackup < ApplicationController
...
# try just generating an album form
  def create
    @album_form = AlbumForm.create(Album.new)
...
#    needed for form partial
    ...
    def set_collection_form
      @collection_form ||= CollectionForm.new(current_user.collections.new)
    end
end
